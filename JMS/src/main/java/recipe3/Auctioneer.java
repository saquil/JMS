...
public class Auctioneer {
    ...
    public Auctioneer(String topiccf, String topicName) {    	
    	try {
    ...
    public static void main(String argv[]) {
    	...
    	if (argv.length == 2) {
    		...
    		System.out.println
               ("java Auctioneer factory topic");
    		System.exit(0);
    	}
      
    	Auctioneer lender = new Auctioneer(topiccf, topicName);
      
    	try {
    		// Read all standard input and send it as a message
    		BufferedReader stdin = new BufferedReader
            	(new InputStreamReader(System.in));
    		System.out.println ("Auctioneer Application Started");
